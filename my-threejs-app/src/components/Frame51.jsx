    ...
    return (
        <div className="frame51-container" ref={containerRef}>
            ...
            >
                ...
                {/* <p>
                    <strong>Gieo hạt</strong> là bước đầu tiên trong hành trình phát triển của cây <strong>thanh long</strong>.
                    Ở giai đoạn này, hệ thống <strong>tưới tự động</strong> sử dụng năng lượng từ <strong>pin mặt trời </strong>
                    giúp duy trì <strong>độ ẩm ổn định</strong>, tạo điều kiện lý tưởng để <strong>hạt giống nảy mầm mạnh mẽ</strong>.
                    <strong> Agri-Solar</strong> đảm bảo <strong>cây trồng</strong> được <strong>chăm sóc hiệu quả </strong>
