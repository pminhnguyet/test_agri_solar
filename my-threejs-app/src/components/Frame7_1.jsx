...
import "../styles/Frame7_1.scss";
import { fetchModelById } from "../utils/request"; // Nhớ đổi path nếu cần
...
export default function Frame7_1() {
    ...
    useEffect(() => {
        async function loadModel() {
            try {
                const model = await fetchModelById(6); // ID = 3
                ...
                <div className="frame7_1-canvas-part" ref={canvasRef}>
                    <Canvas camera={{ position: [0, 0, 5], fov: 50 }}>
                        ...
                        <Suspense fallback={null}>
                            {modelUrl && <Model inView={isCanvasInView} modelUrl={modelUrl} />}
                        </Suspense>
                        <OrbitControls
                            maxPolarAngle={Math.PI / 2}
                            minPolarAngle={0}
