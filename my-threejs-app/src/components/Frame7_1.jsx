...
// // Import hàm fetchModelById từ utils/request.js
// import { fetchModelById } from "../utils/request";

// import "../styles/Frame7_1.scss"

// // Component Model dùng FBXLoader
// function Model({ inView, model }) {
//     const [showPopup, setShowPopup] = useState(false);
...
//                     if (model.position.y > -2) model.position.y = -2;
//                 }
//             } else {
//                 if (model.position.y > -5) {
//                     model.position.y -= 1; // bay ngược về nhanh
...
//     return (
//         <group>
//             <primitive object={model} scale={2} position={[0, -2, 0]} />
...
//     const [model, setModel] = useState(null); // Lưu model
...
//                 const m = await fetchModelById(3); // Lấy model có id = 3 từ request.js
//                 setModel(m); // Lưu model vào state
//             } catch (err) {
//                 setError(err.message); // Nếu có lỗi thì set lỗi
//             } finally {
...
//                             </Html>
//                         ) : model ? (
//                             <Model inView={isCanvasInView} model={model} />
//                         ) : null}
//                         <OrbitControls
//                             maxPolarAngle={Math.PI / 2}
//                             minPolarAngle={0}
